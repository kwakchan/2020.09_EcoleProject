...
const noOwnerMyMatchingItem = (props) => {
  const navigation = props.navigation;
  const { id, homeTeam, date, state, district, countMember, description, matchStatus } = props.noOwnermyMatching;
...
export default noOwnerMyMatchingItem;